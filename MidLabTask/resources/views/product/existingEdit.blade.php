        ...
        <tr>
            ...
            <td>
                <select name="category" id="">
                    ...
                    <option value="Vegatable" @if ($product->catergory=='Vegatable') selected @endif>Vegetable</option>
                    <option value="Meat" @if ($product->catergory=='Meat') selected @endif>Meat</option>
                    <option value="Makeup" @if ($product->catergory=='Makeup') selected @endif>Makeup</option>
                    <option value="Grocery" @if ($product->catergory=='Grocery') selected @endif>Grocery</option>
                </select>
            </td>
        </tr>
        <tr>
